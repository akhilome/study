  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Heroku, Now.sh</li>
        <li>
          RESTful paradigms (built and written unit and integration tests for a
          handful of RESTful APIs at this point)
        </li>
        <li>Typescript</li>
      ...
      <p>Bar Core Software Development, I also have the following experience</p>
      <ul>
        <li>Copywriting</li>
